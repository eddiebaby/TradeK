...
class ContentAnalyzer:
    ...
    def _compile_patterns(self):
        ...
        # Table patterns
        self.table_pattern = re.compile(r"(?P<table>(?:.*?\|.*?\n)+)", re.MULTILINE)
                ...
                regions.append(
                    ContentRegion(
                        ...
                        metadata={
                            "format": "latex",
                            "display": bool(
                                match.group("display") or match.group("env")
                            ),
                        },
                        confidence=0.95,
                    )
    ...
    def extract_special_content(self, text: str) -> dict[str, list[dict[str, Any]]]:
        ...
        for region in regions:
            ...
            if region.content_type == ContentType.CODE:
                ...
                region.content_type == ContentType.REFERENCE
                and region.metadata.get("type") == "strategy"
            ):
