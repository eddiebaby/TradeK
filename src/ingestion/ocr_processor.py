...
class OCRProcessor:
    ...
    def __init__(self, language: str = "eng", dpi: int = 300, thread_workers: int = 4):
        """
    ...
    async def _process_single_image(
        ...
        try:
            ...
            preprocessed = await asyncio.to_thread(self._preprocess_image, image_path)

            # Run OCR
            result = await asyncio.to_thread(self._run_tesseract, preprocessed)
    ...
    def _preprocess_image(self, image_path: str) -> dict[str, Any]:
        ...
        return {"image": binary, "preprocessing": preprocessing_applied}
