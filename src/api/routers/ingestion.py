...
async def list_books(
    ...
    try:
        ...
        return BookListResponse.create(
            items=books, pagination=pagination, total=books_data["total"]
        )
...
async def reprocess_book(
    ...
    try:
        ...
        job_id = str(uuid.uuid4())
        background_tasks.add_task(
            reprocess_book_background, book_processor, book_id, user.id, job_id
        )
...
async def process_book_background(
    ...
    try:
        ...
        logger.error(
            "Book processing failed", book_id=book_id, job_id=job_id, error=str(e)
        )
...
async def reprocess_book_background(
    book_processor: EnhancedBookProcessor, book_id: str, user_id: str, job_id: str
):
    ...
    try:
        ...
        logger.error(
            "Book reprocessing failed", book_id=book_id, job_id=job_id, error=str(e)
        )
