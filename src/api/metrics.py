...
class MetricsCollector:
    ...
    def __init__(self, max_history: int = 10000):
        ...
        self.user_metrics: dict[str, Any] = defaultdict(
            lambda: {
                "search_count": 0,
                "last_activity": None,
    ...
    async def get_search_analytics(self, period_hours: int = 24) -> dict[str, Any]:
        ...
        avg_processing_time = (
            sum(m.processing_time for m in recent_searches) / total_searches
        )
    ...
    async def get_error_metrics(self, period_hours: int = 24) -> dict[str, Any]:
        ...
        if not recent_errors:
            return {"total_errors": 0, "error_rate": 0.0, "error_types": {}}
