...
from .ingestion.resource_monitor import ResourceLimits, ResourceMonitor
...
class TradeKnowledgeApp:
    ...
    def __init__(self):
        ...
        self.ingestion_engine: IngestionEngine | None = None
        self.search_engine: HybridSearch | None = None
        self.mcp_server: TradeKnowledgeServer | None = None
    ...
    async def add_book_command(self, file_path: str, categories: str | None = None):
        """Add a book via CLI"""
    ...
    async def search_command(
        self, query: str, search_type: str = "hybrid", num_results: int = 5
    ):
        """Search via CLI"""
    ...
    async def stats_command(self):
        ...
        try:
            ...
            print(
                f"Average search time: {search_stats['average_search_time_ms']:.1f}ms"
            )
    ...
    async def test_optimized_command(self, pdf_path: str):
        ...
        try:
            ...
            async def detailed_callback(check):
                usage = check["usage"]
                print(
                    f"💾 Memory: {usage['system_used_percent']:.1f}% system, "
            ...
            if result["success"]:
                ...
                print(
                    f"📈 Content analysis: {analysis['code_blocks']} code blocks, "
...
async def main():
    ...
    parser = argparse.ArgumentParser(
        description="TradeKnowledge - AI-Powered Book Search System"
    )
    ...
    add_parser = subparsers.add_parser(
        "add-book", help="Add a book to the knowledge base"
    )
    ...
    test_parser = subparsers.add_parser(
        "test-optimized", help="Test optimized PDF processing"
    )
